...
namespace LibraryAPI.test
{
    public class BooksControllerTest
    {
        ...
        public void GetBookByIdTest(String guid1, String guid2)
        {
            ...
            var invalideGuid = new Guid(guid2);
            //act
            var notFoundResult = _controller.Get(invalideGuid);
        ...
        public void AddBookTest()
        {
            ...
            //act
            _controller.ModelState.AddModelError("Title", "Title is a require field");
        ...
        public void RemoveBookIdTest(String guid1, String guid2)
        {
            ...
            var invalideGuid = new Guid(guid2);
            //act
            var notFoundResult = _controller.Remove(invalideGuid);
            //assert
